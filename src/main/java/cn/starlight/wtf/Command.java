...
public class Command {
            ...
            dispatcher.register(CommandManager.literal("wtf")
                    ...
                    .then(CommandManager.literal("reload")
                            .executes((commandContext) -> {
                                ...
                                commandContext.getSource().sendFeedback(Text.literal("[WTF] §a配置文件已重新加载!"), true);
    ...
    public static int executeCmd(ServerCommandSource source, double distance){
        ...
        source.sendFeedback(Text.literal(String.format("[WTF] §a蜜蜂最大寻巢距离已设定为：%f", distance)), true);
